...
- If you run into any issues with the mandatory section of the dialog, such as "authorization required", it is login or persmissions-related with Go.Data. To resolve this, consult with your Go.Data outbreak administrator.

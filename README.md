...
## Requirements to use toolbox
The Go.Data outbreak administrator will assign you the information below. Currently, the toolbox only works with server-based installations of Go.Data. (Do they need to sign into Go.Data once and change their pass?)

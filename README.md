...
- If you run into any issues with the mandatory section of the dialog, such as "authorization required", it is login or persmissions-related with Go.Data. First make sure you didn't enter your username or password incorrectly. If that doesn't fix it, contact your Go.Data outbreak administrator for resolution.

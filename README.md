...
- When you are in the login portion of the dialog, if you receive this error "authorization required", it could be that you entered the wrong password, username or that you do not have access to an outbreak and you will need to contact your Go.Data outbreak administrator to troubleshoot.

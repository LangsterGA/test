...
- Add the link to the Go.Data site, your user name (email), and your password. 
- Hit the tab button from the password section, and the outbreak section will populate a drop-dwn with outbreaks you have access to. 

...
- In a best case scenario, the administrator utilized an official GIS data source  with admin names and unique identifiers to set up the location data in the system. You may want to ask the administrator or your map requestor, if that is the case. If it was, and you have access so the dataset, the joins will be seamless. If not, you may have to manually adjust either the summary output or your GIS data set to make them match.
